      ...
      <Offcanvas show={show} onHide={handleClose} style={{ maxWidth: '800px', width: '100%' }}>
        ...
        <Offcanvas.Body>
          ...
          <ul>
            ...
            <li><a href="https://book.ryu-sdn.org/en/Ryubook.pdf">RYU Book</a></li>
          </ul>
          ...
          <p>Where the -c argument cleans mininet and is generally recommended to get rid of past flows/data. The second line launches mininet with a remote controller. We generally followed this <a href="https://github.com/mininet/openflow-tutorial/wiki/Learn-Development-Tools">tutorial to set up mininet.</a>
          </p>
          <hr />
          ...
          <p>
            Since the default table_id for mininet (OpenvSwitch) and the <a href="https://ryu.readthedocs.io/en/latest/ofproto_v1_3_ref.html#ryu.ofproto.ofproto_v1_3_parser.OFPFlowMod">OFPFlowMod</a> is table_id=0, meaning that the provided example <a href="https://github.com/faucetsdn/ryu/tree/master/ryu/app">programs</a> should work in mininet without change.
          </p>
          <p>
            For the HP2420-24G switch, flow table 0 is defaulted to the start table, flow table 100 is the hardware table (which can only accept flows with certain <a href="https://community.hpe.com/t5/Software-Defined-Networking/Using-Hardware-flows-table-with-hp-2920-24g/td-p/6931454#.YlypyNrMKUk">matches</a>), and flow table 200 is the software table.
          </p>
          <p>
          ...
          <h3>Programming</h3>
          <p>
            Ryu is programmed via the use of python scripts. There are a bunch of examples on the <a href="https://github.com/faucetsdn/ryu/tree/master/ryu/app">github</a>, along with pretty good <a href="https://ryu.readthedocs.io/en/latest/index.html">documentation here</a>.
          </p>
