  ...
  <span>
    <Container>
      ...
      <ol>
        ...
        <ul>
          <img src="/images/SystemAdmin/MultiHoming_vlans.png" alt="VLANs" style={{ width: '100%', maxWidth: '375px' }} />
        ...
        <ul>
          <img src="/images/SystemAdmin/MultiHoming_dhcpcd.png" alt="dhcpcd" style={{ width: '100%', maxWidth: '375px' }} />
        </ul>
