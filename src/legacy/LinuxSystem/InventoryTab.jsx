  ...
  <span>
    <Table striped bordered responsive="xl">
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>VLAN 1:10.1.1.157</li>
          </ul>
        </td>
        <td>b8:27:eb:80:46:ae</td>
        <td>GUI</td>
        <td>NET</td>
        <td>Remote</td>
        <td>September 2022</td>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>VLAN 1: 10.1.1.170</li>
          </ul>
        </td>
        <td>b8:27:eb:e1:55:6e</td>
        <td>Console</td>
        <td>SYS</td>
        <td>Local</td>
        <td>September 2022</td>
        <td>Server testing pi (that John is working on)</td>
        <td>(X)</td>
      </tr>
      </tbody>
    </Table>
